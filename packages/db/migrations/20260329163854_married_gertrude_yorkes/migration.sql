CREATE TABLE `admin_accounts` (
	...
	CONSTRAINT `fk_admin_accounts_user_id_admin_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `admin_users`(`id`)
);
...
CREATE TABLE `admin_sessions` (
	...
	`created_at` integer NOT NULL,
	`updated_at` integer NOT NULL,
	CONSTRAINT `fk_admin_sessions_user_id_admin_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `admin_users`(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `app_aliases` (
	...
	CONSTRAINT `fk_app_aliases_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps`(`id`)
);
--> statement-breakpoint
CREATE TABLE `apps` (
	`id` text PRIMARY KEY,
...
CREATE TABLE `discovered_apps` (
	...
	`created_at` text NOT NULL,
	`updated_at` text NOT NULL,
	CONSTRAINT `fk_discovered_apps_linked_app_id_apps_id_fk` FOREIGN KEY (`linked_app_id`) REFERENCES `apps`(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `install_executions` (
	...
	`created_at` text NOT NULL,
	`updated_at` text NOT NULL,
	CONSTRAINT `fk_install_executions_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps`(`id`),
	CONSTRAINT `fk_install_executions_release_id_releases_id_fk` FOREIGN KEY (`release_id`) REFERENCES `releases`(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `app_latest_releases` (
	...
	`pinned_by` text,
	`updated_at` text NOT NULL,
	CONSTRAINT `fk_app_latest_releases_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps`(`id`),
	CONSTRAINT `fk_app_latest_releases_release_id_releases_id_fk` FOREIGN KEY (`release_id`) REFERENCES `releases`(`id`),
	CONSTRAINT `fk_app_latest_releases_authority_source_id_sources_id_fk` FOREIGN KEY (`authority_source_id`) REFERENCES `sources`(`id`)
);
--> statement-breakpoint
CREATE TABLE `artifacts` (
	...
	`created_at` text NOT NULL,
	CONSTRAINT `fk_artifacts_release_id_releases_id_fk` FOREIGN KEY (`release_id`) REFERENCES `releases`(`id`)
);
--> statement-breakpoint
CREATE TABLE `release_observations` (
	...
	`created_at` text NOT NULL,
	CONSTRAINT `fk_release_observations_parser_run_id_parser_runs_id_fk` FOREIGN KEY (`parser_run_id`) REFERENCES `parser_runs`(`id`),
	CONSTRAINT `fk_release_observations_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps`(`id`)
);
--> statement-breakpoint
CREATE TABLE `releases` (
	...
	`created_at` text NOT NULL,
	`updated_at` text NOT NULL,
	CONSTRAINT `fk_releases_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps`(`id`),
	CONSTRAINT `fk_releases_published_by_source_id_sources_id_fk` FOREIGN KEY (`published_by_source_id`) REFERENCES `sources`(`id`)
);
--> statement-breakpoint
CREATE TABLE `catalog_suggestions` (
	...
	`created_at` text NOT NULL,
	`updated_at` text NOT NULL,
	CONSTRAINT `fk_catalog_suggestions_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps`(`id`),
	CONSTRAINT `fk_catalog_suggestions_source_id_sources_id_fk` FOREIGN KEY (`source_id`) REFERENCES `sources`(`id`)
);
--> statement-breakpoint
CREATE TABLE `suggestion_evidence` (
	...
	`created_at` text NOT NULL,
	CONSTRAINT `fk_suggestion_evidence_suggestion_id_catalog_suggestions_id_fk` FOREIGN KEY (`suggestion_id`) REFERENCES `catalog_suggestions`(`id`),
	CONSTRAINT `fk_suggestion_evidence_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps`(`id`),
	CONSTRAINT `fk_suggestion_evidence_source_id_sources_id_fk` FOREIGN KEY (`source_id`) REFERENCES `sources`(`id`)
);
--> statement-breakpoint
CREATE TABLE `trust_assertions` (
	...
	`reviewed_by` text,
	`created_at` text NOT NULL,
	CONSTRAINT `fk_trust_assertions_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps`(`id`),
	CONSTRAINT `fk_trust_assertions_source_id_sources_id_fk` FOREIGN KEY (`source_id`) REFERENCES `sources`(`id`)
);
--> statement-breakpoint
CREATE TABLE `parser_runs` (
	...
	`started_at` text NOT NULL,
	`finished_at` text,
	CONSTRAINT `fk_parser_runs_source_fetch_id_source_fetches_id_fk` FOREIGN KEY (`source_fetch_id`) REFERENCES `source_fetches`(`id`)
);
--> statement-breakpoint
CREATE TABLE `source_fetches` (
	...
	CONSTRAINT `fk_source_fetches_source_id_sources_id_fk` FOREIGN KEY (`source_id`) REFERENCES `sources`(`id`)
);
--> statement-breakpoint
CREATE TABLE `sources` (
	...
	`created_at` text NOT NULL,
	`updated_at` text NOT NULL,
	CONSTRAINT `fk_sources_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps`(`id`)
);
--> statement-breakpoint
