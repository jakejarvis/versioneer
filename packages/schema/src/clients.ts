...
export const clients = sqliteTable("clients", {
  ...
  index("idx_clients_install_id").on(table.anonymousInstallId),
]);

export const clientInventorySnapshots = sqliteTable("client_inventory_snapshots", {
  id: text("id").primaryKey(),
  ...
  index("idx_snapshots_client_id").on(table.clientId),
]);

export const clientInventoryApps = sqliteTable("client_inventory_apps", {
  id: text("id").primaryKey(),
  snapshotId: text("snapshot_id").notNull().references(() => clientInventorySnapshots.id),
