/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2cb6a137f9c3d01f42de65b438f3628a)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		DB: D1Database;
		INVENTORY_INGESTION_QUEUE: Queue;
		ENVIRONMENT: "production";
		POSTHOG_HOST: "https://us.i.posthog.com";
		GITHUB_TOKEN: string;
		POSTHOG_PROJECT_TOKEN: string;
		SOURCE_PIPELINE: Workflow<Parameters<import("./src/index").SourcePipelineWorkflow['run']>[0]['payload']>;
		ENRICHMENT_DRAIN: Workflow<Parameters<import("./src/index").EnrichmentDrainWorkflow['run']>[0]['payload']>;
		INVENTORY_INGESTION: Workflow<Parameters<import("./src/index").InventoryIngestionWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		CACHE_KV: KVNamespace;
		CONFIG_KV: KVNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "POSTHOG_HOST" | "GITHUB_TOKEN" | "POSTHOG_PROJECT_TOKEN">> {}
}
