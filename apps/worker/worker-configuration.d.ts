/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a796fc4ea310109b67d78346320abac0)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		DB: D1Database;
		INVENTORY_FOLLOWUP_QUEUE: Queue;
		...
		INVENTORY_FOLLOWUP: Workflow<Parameters<import("./src/index").InventoryFollowupWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		CACHE_KV: KVNamespace;
		CONFIG_KV: KVNamespace;
