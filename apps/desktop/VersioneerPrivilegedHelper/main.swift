...
private final class PrivilegedHelperListenerDelegate: NSObject, NSXPCListenerDelegate {
    ...
    private func homeDirectory(for userIdentifier: uid_t) -> URL? {
        ...
        return URL(fileURLWithFileSystemRepresentation: directoryCString, isDirectory: true, relativeTo: nil)
    }
}
...
if #available(macOS 13.0, *) {
    listener.setConnectionCodeSigningRequirement(PrivilegedHelperConstants.mainAppCodeSigningRequirement)
}
