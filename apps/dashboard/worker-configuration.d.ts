/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce5529b16afcef1b91ffb1f8173346ee)
...
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		SOURCE_PIPELINE: Workflow /* SourcePipelineWorkflow from versioneer-worker */;
	}
	interface Env {
		CONFIG_KV: KVNamespace;
		ASSETS_BUCKET: R2Bucket;
		...
		ALLOWED_ADMIN_EMAILS: string;
		GITHUB_TOKEN: string;
		PIPELINE_WORKER: Fetcher /* versioneer-worker-production */ | Fetcher /* versioneer-worker-dev */;
		SOURCE_PIPELINE: Workflow /* SourcePipelineWorkflow from versioneer-worker */;
	}
}
