/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8d186bcba122a7ce5fdf9d88ba993a1d)
// Runtime types generated with workerd@1.20260421.1 2026-02-24 nodejs_compat
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		ASSETS_BASE_URL: "https://assets-prod.versioneer.app";
		BETTER_AUTH_SECRET: string;
		GITHUB_OAUTH_CLIENT_ID: string;
		GITHUB_OAUTH_CLIENT_SECRET: string;
		ALLOWED_ADMIN_EMAILS: string;
		GITHUB_TOKEN: string;
		PIPELINE_WORKER: Fetcher /* versioneer-worker-production */;
		SOURCE_PIPELINE: Workflow /* SourcePipelineWorkflow from versioneer-worker-production */;
		ENRICHMENT_DRAIN: Workflow /* EnrichmentDrainWorkflow from versioneer-worker-production */;
	}
	interface Env {
		CONFIG_KV: KVNamespace;
		ASSETS_BUCKET: R2Bucket;
		...
		ASSETS_BASE_URL: "https://assets-prod.versioneer.app" | "http://localhost:5173/assets";
		BETTER_AUTH_SECRET?: string;
		GITHUB_OAUTH_CLIENT_ID?: string;
		GITHUB_OAUTH_CLIENT_SECRET?: string;
		ALLOWED_ADMIN_EMAILS?: string;
		GITHUB_TOKEN?: string;
		PIPELINE_WORKER: Fetcher /* versioneer-worker-production */ | Fetcher /* versioneer-worker */;
		SOURCE_PIPELINE: Workflow /* SourcePipelineWorkflow from versioneer-worker-production */ | Workflow /* SourcePipelineWorkflow from versioneer-worker */;
		ENRICHMENT_DRAIN: Workflow /* EnrichmentDrainWorkflow from versioneer-worker-production */ | Workflow /* EnrichmentDrainWorkflow from versioneer-worker */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ASSETS_BASE_URL" | "BETTER_AUTH_SECRET" | "GITHUB_OAUTH_CLIENT_ID" | "GITHUB_OAUTH_CLIENT_SECRET" | "ALLOWED_ADMIN_EMAILS" | "GITHUB_TOKEN">> {}
}
